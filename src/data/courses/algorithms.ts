...
export const algorithmsCourse: Course = {
  ...
  subtitle:
    "Explore searching, sorting, recursion, graphs, weighted paths, and greedy thinking through guided labs.",
  sourceNote:
    "Original interactive lessons inspired by common algorithm topics from the imported PDF outline.",
  lessons: [
    {
      ...
      summary:
        "Algorithms are recipes with tradeoffs. Binary search shows the core idea beautifully: ordered data lets each question cut the remaining search space in half.",
      outcomes: [
